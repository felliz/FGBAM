...
def insert_queue(socket,maxRate,minRate,db_name,current_id,db = DEFAULT_DB,priority = 0):
    transact_insert_Queue = {"method":"transact", "params":[db_name,{"op":"insert" , "table":"Queue" , "row":{"other_config":["map",[["max-rate",str(maxRate)],["min-rate",str(minRate)],["priority",str(priority)]]]} } ] , "id": current_id}
